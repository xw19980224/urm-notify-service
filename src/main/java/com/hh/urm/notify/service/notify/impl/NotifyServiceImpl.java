...
public class NotifyServiceImpl implements INotifyService {
    ...
    public ServiceResponse<Object> sendMessage(NotifyDTO notifyDTO) {
        ...
        List<String> notifyType = Arrays.stream(notifyDTO.getNotifyType()).collect(Collectors.toList());
        ...
        for (String topic : topicList) {
            data.forEach(item -> {
                        ...
                        // 2.1将NotifyDataDTO对象转换为JsonObject，并将traceId封装到 jsonObject
                        ...
                        future.addCallback(new ListenableFutureCallback<SendResult<String, Object>>() {
                            ...
                            public void onFailure(Throwable throwable) {
                                ...
                                recordHistory(traceId, String.valueOf(configTopicsList.indexOf(topic)), NotifyConst.KafkaStateEnums.EXCEPTION.getCode(), item, throwable.getMessage());
                            }
                            ...
                            public void onSuccess(SendResult<String, Object> stringObjectSendResult) {
                                ...
                                recordHistory(traceId, String.valueOf(configTopicsList.indexOf(topic)), NotifyConst.KafkaStateEnums.READY.getCode(), item, null);
                            }
                        });
                    }
            );
     ...
     * @param msg        描述
     */
    public void recordHistory(String traceId, String type, int status, NotifyDataDTO notifyData, String msg) {
